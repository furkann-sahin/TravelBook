...
import com.codelegends.travelbook.viewmodel.RegisterEvent
import com.codelegends.travelbook.viewmodel.RegisterUiState
            ...
            Card(
                ...
                Column(
                    ...
                    Button(
                        ...
                        Text(
                            text = if (uiState.isLoading) "Kayıt yapılıyor..." else "Kayıt Ol",
...
@Composable
private fun CompanyRegisterForm(
