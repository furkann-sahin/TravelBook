...
import com.codelegends.travelbook.viewmodel.UserLoginEvent
...
fun UserLoginScreen(
    ...
    LaunchedEffect(Unit) {
        viewModel.events.collect { event ->
            when (event) {
                is UserLoginEvent.NavigateToHome -> onNavigateToHome(event.session)
                UserLoginEvent.NavigateToRegister -> onNavigateToRegister()
            }
        }
    }
